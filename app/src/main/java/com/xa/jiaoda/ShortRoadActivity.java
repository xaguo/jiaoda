...
public class ShortRoadActivity extends AppCompatActivity {
   ...
   LocationService.myBinder binder = null;
     ...
     * 开始定位
     */
    private void startLocation(boolean data) {
    ...
    {
        mMenu_right.setOnMenuItemClickListener(new ArcMenu.OnMenuItemClickListener()
        {
            @Override
     ...
     *获取路线
     */
    public  void getRoad(int routeHandle) {
        ...
        try {
            ...
            routeHandle = mGraphicsLayer.addGraphic(new Graphic(geom,
                    new SimpleLineSymbol(0x990000ff, 3)));// 颜色 宽度//99990055
